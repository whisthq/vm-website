...
class Reset extends Component {
    ...
    handlePasswordReset = () => {
        this.setState({ processing: true });
        this.props.dispatch(
            resetPassword(this.props.forgot_email, this.state.passwordSignup)
        );
    };
                ...
                <div>
                    ...
                    >
                        <div style={{ margin: "auto", maxWidth: 500 }}>
                            ...
                            >
                                For your security, this password link has
                                expired. You can request a new password reset
                                link{" "}
                                <a
                                    href="https://fractalcomputers.com/reset"
                    ...
                    <div>
                        ...
                        >
                            <div style={{ margin: "auto", maxWidth: 500 }}>
                                ...
                                >
                                    An email with a password reset link has been
                                    sent the email address that you specified.
                                    For security, the link will expire in ten
                                    minutes.
                                </div>
                                <HashLink to="/auth">
                                    <Button
