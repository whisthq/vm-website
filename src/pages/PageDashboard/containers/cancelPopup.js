...
class DownloadBox extends Component {
    ...
    render() {
        if(this.props.created !== "" || (this.props.customer && Object.keys(this.props.customer).length > 0)) {
                        ...
                        <div>
                            {!this.state.exitSurvey ? (
                                <div>
                                    ...
                                    >
                                        If you cancel, all the data, files, and applications stored on 
                                        your cloud PC will be{" "}<strong>permanently</strong>{" "}deleted.
                                        Please make sure that you have transferred everything you need from
                                        your cloud PC to another device before proceeding.
                                    </div>
                                    <button
                                        onClick={() =>
                                            this.showExitSurvey(
                                ...
                                <div className="exit-survey">
                                    ...
                                    <Button
                                        ...
                                        style={{
                                            fontWeight:
                                                "bold",
                                            marginTop: this.state.width > 700 ? 19 : 65,
                                            outline:
                                                "none",
                                            width:
                                                "100%",
                                        ...
                                        disabled = {this.state.exitFeedback === ""}
                                    >
                                        CANCEL PLAN
                                    </Button>
                                </div>
