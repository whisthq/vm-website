...
class PriceBox extends Component {
  ...
  render() {
    ...
    return(
      <div style = {{borderRadius: 5, boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.1)', textAlign: 'left', background: `${ this.props.color }`, padding: 30, minHeight: 240, width: '100%', marginBottom: 20}}>
