...
import { changePlan, changePlanStatus } from "../../actions/index.js";
...
function mapStateToProps(state) {
    return {
        ...
        change_plan_status: state.AccountReducer.change_plan_status
            ? state.AccountReducer.change_plan_status
            : 0,
    };
}
