...
class Auth extends Component {
  ...
  handleSignup = (evt) => {
    ...
    this.props.dispatch(
      userSignup(this.state.emailSignup, this.state.passwordSignup, false)
    );
          ...
          <div style={{ position: "relative", margin: "auto", maxWidth: 1920 }}>
            ...
            >
              {this.state.lock ? (
                ...
                >
                  April 11, 2020: Fractal is currently undergoing a major
                  update, and will be back online in less than 48 hours. We
                  apologize for the inconvenience; please check back again soon!
                </div>
              ) : (
                <div></div>
              )}
                    ...
                    {!this.state.processing ? (
                      ...
                      >
                        <FontAwesomeIcon
                          icon={faCircleNotch}
                          spin
                          style={{ color: "white", height: 14, marginRight: 5 }}
                        />{" "}
                        Processing
                      </Button>
                    )}
...
>>>>>>> master
                      ...
                      >
                        ...
                        <Link
                          to="/termsofservice"
                          style={{ textDecoration: "none", color: "#5ec3eb" }}
                        >
                          Terms of Service&nbsp;
                        </Link>
                        and&nbsp;
