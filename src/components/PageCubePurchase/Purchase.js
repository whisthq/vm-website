...
class Purchase extends Component {
  ...
  handleClick2 = () => {
    if (options.includes(this.props.purchase_location)) {
      ...
      if (unsupported.includes(this.props.purchase_location)) {
        ...
        this.setState(
          { step: 3, location: this.props.purchase_location, continue2: false },
          function () {
            this.props.dispatch(storePurchaseLocation(""));
          }
        );
  ...
  render() {
        ...
        if (this.state.step === 1) {
          return (
            <div>
              <div style={{ paddingBottom: 20 }}>
                <div style={{ fontWeight: "bold", color: "#111111" }}>
                  Country
                </div>
          ...
          return (
            <div>
              ...
              <div style={{ paddingBottom: 20 }}>
                <div style={{ color: "#111111", fontWeight: "bold" }}>
                  Cloud PC Type
                </div>
                <div style={{ color: "#B9B9B9", fontSize: 12 }}>
                  {this.state.computer}
        ...
        return (
          <div
            style={{
              paddingTop: 100,
              paddingLeft: 0,
              width: this.state.width > 700 ? "calc(100% - 400px)" : "90%",
            ...
            >
              {this.state.width > 700 ? (
                <span style={{ position: "relative", bottom: 2 }}>
                  1{" "}
                  <FaArrowRight
                    style={{ height: 10, position: "relative", bottom: 2 }}
                  />
                </span>
              ) : (
                <div></div>
              ...
              >
                Currently, Fractal only has servers in certain geographic
                locations.
              </div>
              {this.state.country === "" ? (
                <div
        ...
        return (
          <div
            style={{
              paddingTop: 100,
              paddingLeft: 0,
              width: this.state.width > 700 ? "calc(100% - 400px)" : "95%",
              overflowX: "hidden !important",
              paddingRight: 40,
            }}
          >
            ...
            >
              ...
              <div>
                ...
                Midwestern United States due to the locations of our servers. We
                are quickly expanding to West Coast and beyond; if you'd like to
                be notified when Fractal is available in your location, please
                join our wait list!
              </div>
              <HashLink to="/#beta" style={{ textDecoration: "none" }}>
                <Button
                  style={{
                    display: "inline",
                    marginTop: 50,
                    padding: this.state.width > 700 ? "12px 50px" : "12px 30px",
                    background: "#111111",
                    border: "none",
                    color: "white",
                    boxShadow: "0px 4px 20px rgba(0, 0, 0, 0.1)",
        ...
        return (
          ...
          >
            <div>
              ...
              >
                After your free trial, you'll have the opportunity to select one
                of these plans, depending on your computing needs. We hope that
                your free trial will help you figure out which plan works best
                for you!
              </div>
              <Row
                style={{
              ...
              <div
                style={{
                  float: this.state.width > 700 ? "none" : "right",
                  marginTop: this.state.width > 700 ? 0 : 20,
                  position: this.state.width > 700 ? "absolute" : "relative",
    ...
    return (
      <div
        style={{ minHeight: "100vh", paddingBottom: 50, background: "#F6F6F6" }}
      >
