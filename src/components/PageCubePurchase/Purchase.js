...
class Purchase extends Component {
  ...
  render() {
    ...
    const renderSurvey = () => {
      if(this.state.step === 1) {
        return(
          <div style = {{paddingTop: 100, paddingLeft: 0, width: this.state.width > 700 ? 'calc(100% - 400px)' : '90%', overflowX: 'hidden !important', paddingRight: this.state.width > 700 ? 0: 40}}>
            <div style = {{padding: '40px 50px', boxShadow: '0px 4px 20px rgba(0, 0, 0, 0.1)', borderRadius: 5, width: '100%', maxWidth: 1200}}>
              ...
              <span style = {{fontSize: 22, paddingLeft: this.state.width > 700 ? 10 : 0}}>Do you live in the United States?</span>
              <div style = {{marginTop: 5, color: '#333333', paddingLeft: this.state.width > 700 ? 39 : 0, fontSize: 16}}>
                Currently, Fractal only has servers in certain geographic locations.
              </div>
              {
              this.state.country === ''
              ?
              <div style = {{outline: 'none', marginTop: 20, display: this.state.width > 700 ? 'flex' : 'block', justifyContent: 'space-between', width: 480, paddingLeft: this.state.width > 700 ? 39 : 0}}>
                ...
                <Button disabled = "true" style = {{background: '#111111', border: 'none', width: 140, height: 42, fontSize: 14, marginTop: this.state.width > 700 ? 10 : 15}}>
                  Continue
                </Button>
              </div>
              :
              ...
              ?
              <div tabIndex="0" onKeyDown={(e) => this.handleKeyPress1(e)}  style = {{marginTop: 20, display: this.state.width > 700 ? 'flex' : 'block', justifyContent: 'space-between', width: 480, paddingLeft: this.state.width > 700 ? 39 : 0}}>
                <div onClick = {() => this.setCountry('United States')} style = {{maxWidth: 150, marginBottom: 5}}>
                ...
                <Button onClick = {() => this.handleClick1(true)} style = {{background: '#111111', border: 'none', width: 140, height: 42, fontSize: 14, marginTop: this.state.width > 700 ? 10 : 15}}>
                  Continue
                </Button>
              </div>
              :
              <div tabIndex="0" onKeyDown={(e) => this.handleKeyPress1(e)} style = {{marginTop: 20, display: this.state.width > 700 ? 'flex' : 'block', justifyContent: 'space-between', width: 480, paddingLeft: this.state.width > 700 ? 39 : 0}}>
                ...
                <Button onClick = {() => this.handleClick1(false)} style = {{background: '#111111', border: 'none', width: 140, height: 42, fontSize: 14, marginTop: this.state.width > 700 ? 10 : 15}}>
                  Continue
                </Button>
              </div>
              )
        ...
        return (
        <div style = {{paddingTop: 100, paddingLeft: 0, width: this.state.width > 700 ? 'calc(100% - 400px)' : '95%', overflowX: 'hidden !important', paddingRight: 40}}>
          <div style = {{padding: '40px 50px', boxShadow: '0px 4px 20px rgba(0, 0, 0, 0.1)', borderRadius: 5, maxWidth: 1200, fontSize: 16, lineHeight: 1.6}}>
            ...
            <HashLink to = "/#beta" style = {{textDecoration: 'none'}}>
              <Button style = {{display: 'inline', marginTop: 50, padding: this.state.width > 700 ? "12px 50px" : "12px 30px", background: "#111111", border: 'none', color: 'white', boxShadow: '0px 4px 20px rgba(0, 0, 0, 0.1)'}}>Join Wait List</Button>
            </HashLink>
          </div>
        ...
        return(
          <div style = {{paddingTop: 100, paddingLeft: 0, width: this.state.width > 700 ? 'calc(100% - 400px)' : '95%', paddingRight: this.state.width > 700 ? 0 : 40}} onKeyPress = {this.handleKeyPress2}>
            <div className = "state-select" style = {{padding: '40px 50px', boxShadow: '0px 4px 20px rgba(0, 0, 0, 0.1)', borderRadius: 5, maxWidth: 1200, maxHeight: 'calc(100vh - 150px)'}}>
              ...
              <span style = {{fontSize: 22, paddingLeft: this.state.width > 700 ? 10 : 0}}>What state do you live in?</span>
              <div style = {{marginTop: 5, color: '#333333', paddingLeft: this.state.width > 700 ? 39 : 0, fontSize: 16}}>
                So we can find servers closest to you.
              </div>
              <div style = {{marginTop: 30, paddingLeft: this.state.width > 700 ? 39 : 0}}>
                <Autocomplete
                ...
                ?
                <Button onClick = {this.handleClick2} style = {{background: '#111111', border: 'none', padding: '10px 25px', display: 'inline', position: 'relative', bottom: 2, marginTop: this.state.width > 700 ? 0 : 15, width: this.state.width > 500 ? 150 : '90%'}}>
                  Continue
                </Button>
                :
                <div></div>
        ...
        return(
          <div tabIndex="0" onKeyDown={(e) => this.handleKeyPress3(e)} style = {{outline: 'none', paddingTop: 100, paddingLeft: 0, width: this.state.width > 700 ? 'calc(100% - 400px)' : '95%', overflowX: 'hidden !important', paddingRight: this.state.width > 700 ? 0 : 40}}>
            <div>
              {
              this.state.width > 700
              ?
              ...
              <span style = {{fontSize: 22, paddingLeft: this.state.width > 700 ? 10 : 0}}>Choose Your Cloud Computer</span>
              <div style = {{marginTop: 5, color: '#333333', paddingLeft: this.state.width > 700 ? 39 : 0, fontSize: 16, maxWidth: 650}}>
                Select the specs that best suit your needs. You can always upgrade or downgrade later.
              </div>
              {
              this.state.computer === ''
              ?
              <Row style = {{marginTop: 50, paddingLeft: this.state.width > 700 ? 39 : 0, maxWidth: 800}}>
                <Col md = {6} className = "pointerOnHover" style = {{marginBottom: this.state.width > 700 ? 0 : 20, paddingRight: this.state.width > 700 ? 0 : 40}} onClick = {() => this.setState({computer: 'Medium'})}>
                  <SpecBox name = "Medium" cpu = "6" gpu = "1/2" ram = "56" 
                    description = "For 3D modeling, medium rendering, gaming."
                    pricing = "Start with free trial"
                    color = "white"/>
                </Col>
                <Col md = {6} style = {{marginBottom: this.state.width > 700 ? 0 : 20, paddingRight: this.state.width > 700 ? 0 : 40}}>
              ...
              this.state.computer !== ''
              ?
              <div style = {{display: 'flex', justifyContent: 'space-between', width: 310, marginTop: 40, paddingLeft: this.state.width > 700 ? 39 : 0}}>
              ...
              :
              <div style = {{display: 'flex', justifyContent: 'space-between', width: 375, marginTop: 40, paddingLeft: this.state.width > 700 ? 39 : 0}}>
        ...
        return(
          <div tabIndex="0" onKeyDown={(e) => this.handleKeyPress4(e)} style = {{outline: 'none', paddingTop: 100, paddingLeft: 0, width: this.state.width > 700 ? 'calc(100% - 400px)' : '95%', overflowX: 'hidden !important', paddingRight: this.state.width > 700 ? 0 : 40}}>
            <div>
              {
              this.state.width > 700
              ?
              ...
              ?
              <span style = {{fontSize: 22, paddingLeft: this.state.width > 700 ? 10 : 0}}>Your First Week Is On Us!</span>
              :
              (
              this.props.credits === 1
              ?
              <span style = {{fontSize: 22, paddingLeft: this.state.width > 700 ? 10 : 0}}>Your First Month Is On Us!</span>
              :
              <span style = {{fontSize: 22, paddingLeft: this.state.width > 700 ? 10 : 0}}>Your First {this.props.credits} Months Is On Us!</span>
              )
              } 
              <div style = {{marginTop: 5, color: '#333333', paddingLeft: this.state.width > 700 ? 39 : 0, fontSize: 16, maxWidth: 650}}>
              ...
              <Row style = {{marginTop: 50, paddingLeft: this.state.width > 700 ? 55 : 16}}>
              ...
              ?
              <div style = {{display: 'flex', justifyContent: 'space-between', width: 355, marginTop: 40, paddingLeft: this.state.width > 700 ? 39 : 0}}>
              ...
              :
              <div style = {{display: 'flex', justifyContent: 'space-between', width: 300, marginTop: 40, paddingLeft: this.state.width > 700 ? 39 : 0}}>
              ...
              <div style = {{float: this.state.width > 700 ? 'none' : 'right', marginTop: this.state.width > 700 ? 0 : 20, position: this.state.width > 700 ? 'absolute' : 'relative', bottom: this.state.width > 700 ? 25 : 0, right: this.state.width > 700 ? 40 : 0, boxShadow: this.state.width > 700 ? '0px 4px 20px rgba(0, 0, 0, 0.3)' : 'none', background: 'none'}}>
                <div onClick = {this.goBack} style = {{display: 'inline', borderRadius: '5px 0px 0px 5px', backgroundColor: '#5ec3eb', color: 'white', padding: '5px 10px', borderRight: 'solid 0.5px #0b172b'}}>
                  <FaAngleUp className = "typeform-up" style = {{height: 20, position: 'relative', bottom: 2, color: '#0b172b'}}/>
                </div>
                <Link to = "/dashboard">
      ...
      <div style = {{minHeight: '100vh', paddingBottom: 50, background: '#F6F6F6'}}>
        <div style = {{maxWidth: 1920, margin: 'auto'}}>
          ...
          <div style = {{display: 'flex', overflowX: 'hidden', position: 'relative', bottom: 60}}>
            <div style = {{width: this.state.width > 700 ? 300 : 0, paddingLeft: this.state.width > 700 ? 80 : 40, paddingTop: 120, backgroundColor: 'none', height: '100%', minHeight: '100vh', zIndex: 0}}>
            {renderLeftMenu()}      
            </div>
            {renderSurvey()}
          </div>
