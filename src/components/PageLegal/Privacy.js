  ...
  render() {
    ...
    return(
      ...
      <div style = {{padding: '125px 150px', maxWidth: 1280}}>
        ...
        <div style = {{fontWeight: 'bold', marginBottom: 20, marginTop: 40}}>
        Table Of Contents
        </div>
        <div>
          ...
          9. Advertising and Analytics Services Provided by Others<br/>
        ...
        We collect first name, maiden name, last name, and pseudonyms email addresses; business email; business phone number; phone numbers; social media; state of residence; country of residence and other similar data. 
        Personal Information Provided by You 
        We collect app usage data; app usage location; data collected from surveys; and other similar data.
        Credentials 
        ...
        We may provide you with the option to register using social media account details, like your Facebook, Twitter or other social media account. If you choose to register in this way, we will collect the Information described in the section called "HOW DO WE HANDLE YOUR SOCIAL LOGINS" below.
        ...
        Online Identifiers
        We collect device identification (i.e. type, make, and other identifiers); applications; tools and protocols, such as IP (Internet Protocol) addresses; cookie identifiers, or others such as the ones used for analytics and marketing; device's geolocation; and other similar data.
        ...
        To send you personalized marketing and promotional communications. We and/or our third party marketing partners may use the personal information you send to us for our marketing purposes, if this is in accordance with your marketing preferences. You can opt-out of our marketing emails at any time (see the "What Are Your Privacy Rights" below).
        ...
        Third-Party Advertisers. We may use third-party advertising companies to serve ads when you visit the Services. These companies may use information about your visits to our Website(s) and other websites that are contained in web cookies and other tracking technologies in order to provide personalized advertisements about goods and services. 
        <div style = {{fontWeight: 'bold', marginBottom: 20, marginTop: 40}}>
