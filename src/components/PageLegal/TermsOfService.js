    ...
    return(
      ...
      <div style = {{padding: this.state.width > 700 ? '75px 150px' : '50px 40px', maxWidth: 1280, margin: 'auto'}}>
        ...
        <div>
          ...
          <p>
          These Terms of Service were last updated on the date specified above. It is effective between Fractal and you as of the date you accept these Terms of Service.
          </p>
          ...
          <p>
          Fractal reserves the right to permanently delete any user Data found on a server that is no longer subscribed to by a user 7 days after a user has cancelled their plan. You will receive one or many emails notifying you ahead of time that your data is scheduled for deletion, to provide you with the opportunity to download it locally.
          </p>
          <p style = {{fontWeight: 'bold', fontSize: 20}}>
          Referral Programs
          </p>
          ...
          <p>
          While using Fractal cloud computers, you will send us various files, content, emails, contacts, etc. (the “User Content”). The User Content belongs to the User and in no way to Fractal. Fractal is only granted the right to use the User Content to the extent required for the proper functioning of the Services. These limited rights include in particular, the right to host, save, and share the User Content, for the intended functioning of the User’s computer.
          </p>
          <p>
          ...
          <p>
          To that effect, before filing a claim against us, you agree to try to resolve the dispute informally by opening a support ticket via email to <a href = "mailto: support@fractalcomputers.com">support@fractalcomputers.com</a>.  We will try to resolve the dispute informally.  If a dispute is not resolved within fifteen days of submission, you or we may bring a formal proceeding.
          </p>
          <p>
